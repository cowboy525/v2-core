...
import WIRE_UP_CONFIG from "../config/lz/wireUpConfig.json"
import ENDPOINTS from "../config/lz/layerzeroEndpoints.json"
import ABI from "../config/lz/endpoint_abi.json"
