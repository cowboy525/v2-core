	...
	RecoverERC20
{
	 ...
	 */
	function lockedBalances(address user) public view returns (
		uint256 total,
		uint256 unlockable,
		uint256 locked,
	 ...
	 */
	function earnedBalances(address user) public view returns (
	 ...
	 */
	function withdrawableBalance(address user) public view returns (
		uint256 amount, 
		uint256 penaltyAmount, 
		uint256 burnAmount
	) {
