...
contract BalancerPoolHelper is IBalancerPoolHelper, Initializable, OwnableUpgradeable, BNum, DustRefunder {
	...
	/**
	 * @notice naive price view function, using LP reserves
	 * @return price in ETH, decis 8
	 */
	...
	/**
	 * @notice return info on LP reserves
	 * @return rdnt amount in LP
	 * @return weth amount in LP
	 * @return lpTokenSupply amt of BLP in circ
	 */
	...
	function quoteFromToken(uint256 tokenAmount) public view override returns (uint256 optimalWETHAmount) {
		...
		optimalWETHAmount = ethRequiredBeforeWeight.div(POOL_WEIGHT);
	}
